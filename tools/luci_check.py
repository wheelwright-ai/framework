...
SPOKE_PATH = Path(sys.argv[sys.argv.index("--spoke-path") + 1] if "--spoke-path" in sys.argv else ".")
TIER_OVERRIDE = sys.argv[sys.argv.index("--tier") + 1] if "--tier" in sys.argv else None
