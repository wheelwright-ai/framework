...
def get_lug_id(lug):
    return get_field(lug, "id", "i") or "unknown"


def get_lug_type(lug):
    raw = get_field(lug, "type", "ty") or "unknown"
...
def get_lug_status(lug):
    return get_field(lug, "status", "s") or "unknown"


def get_lug_title(lug):
    title = get_field(lug, "title", "t") or ""
