...
3. If briefing shows pending teachings in seed/ingest/:
   Include them in the briefing first. Do NOT stop wakeup before the briefing is complete.
   Do not read full teaching bodies unless the user explicitly asks to review them now.
