...
**Structure:** v1 (.wwai/ directory)
**Hub:** *Not yet configured - run `wwai hub create` or `wwai hub locate`*
...
1. Read `WWAI-Guide.md` for current policies
2. Check `_project_foundation.completed` in WWAI-State.json
...
- `'Closeout'` - Generate updated WWAI-State files
