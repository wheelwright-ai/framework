...
Generates CLAUDE.md configuration and slash commands for Claude Code CLI.
"""
...
class ClaudeCodeIntegration(IDEIntegration):
    ...
    # Claude Code stores slash commands in .claude/commands/
    ...
    def generate_config(self, template_vars: Optional[Dict[str, Any]] = None) -> str:
        ...
        # Check for custom template (framework uses its own)
        ...
        # Generate config for other projects
...
*To update: `WAI configure-ide --force`*
"""
