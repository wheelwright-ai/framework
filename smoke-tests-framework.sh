...
test_file_exists "WAI-Spoke/wheel-signals.jsonl exists" "./WAI-Spoke/wheel-signals.jsonl"
...
test_jsonl_valid "wheel-signals.jsonl is valid JSONL" "./WAI-Spoke/wheel-signals.jsonl"
...
test_content_contains "session-start hook initializes conversation log" "./WAI-Spoke/hooks/session-start.sh" "session-conversation.jsonl"
