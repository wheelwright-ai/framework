...
test_file_exists "WAI CLI tool exists" "./WAI"
test_condition "WAI CLI is executable" "[[ -x ./WAI ]]" "success"
test_condition ".WAI directory exists (capitalized)" "[[ -d ./.WAI ]]" "success"
test_file_exists ".WAI/WAI-State.json exists" "./.WAI/WAI-State.json"
test_file_exists ".WAI/WAI-State.md exists" "./.WAI/WAI-State.md"
test_file_exists ".WAI/WAI-Guide.md exists" "./.WAI/WAI-Guide.md"
test_file_exists ".WAI/wheel-signals.jsonl exists" "./.WAI/wheel-signals.jsonl"
...
test_condition "WAI-Guide.md has no WWAI references" "! grep -q 'WWAI' ./.WAI/WAI-Guide.md" "success"
test_condition "WAI-State.md has no WWAI references" "! grep -q 'WWAI' ./.WAI/WAI-State.md" "success"
...
test_condition "WAI-Guide.md has no 'Wheel Wright'" "! grep -q 'Wheel Wright' ./.WAI/WAI-Guide.md" "success"
...
test_jsonl_valid "wheel-signals.jsonl is valid JSONL" "./.WAI/wheel-signals.jsonl"

echo ""
echo "=== SECTION 5: Session Start Hook ==="
echo ""

test_file_exists "session-start.sh exists" "./.WAI/hooks/session-start.sh"
test_condition "session-start.sh is executable" "[[ -x ./.WAI/hooks/session-start.sh ]]" "success"
test_condition "session-start.sh has no CRLF line endings" "! file ./.WAI/hooks/session-start.sh | grep -q 'CRLF'" "success"
test_content_contains "session-start hook uses .WAI/ paths" "./.WAI/hooks/session-start.sh" ".WAI/WAI-State.json"
test_content_contains "session-start hook initializes conversation log" "./.WAI/hooks/session-start.sh" "session-conversation.jsonl"
...
test_content_contains ".claude/settings.json uses .WAI/ path" "./.claude/settings.json" ".WAI/hooks/session-start.sh"

echo ""
echo "=== SECTION 7: Unit Tests ==="
echo ""

test_file_exists "test-session-start.sh exists" "./.WAI/hooks/test-session-start.sh"
test_condition "test-session-start.sh is executable" "[[ -x ./.WAI/hooks/test-session-start.sh ]]" "success"
test_condition "Unit tests pass" "./.WAI/hooks/test-session-start.sh" "success"
...
test_content_contains "WAI-Guide.md documents conversation logging" "./.WAI/WAI-Guide.md" "Conversation Logging"
...
test_content_contains "WAI-Guide.md mentions hub learning dependency" "./.WAI/WAI-Guide.md" "Hub learning cannot proceed"
...
test_content_contains "WAI-Guide.md has Token Efficiency section" "./.WAI/WAI-Guide.md" "Token Efficiency & Multi-Stage Workflow"
test_content_contains "WAI-Guide.md has ADAPTIVE workflow" "./.WAI/WAI-Guide.md" "ADAPTIVE Workflow Mode"
test_content_contains "WAI-Guide.md has standardized plan template" "./.WAI/WAI-Guide.md" "Standardized Plan Template"
test_content_contains "WAI-Guide.md has checkpointing protocol" "./.WAI/WAI-Guide.md" "Checkpointing Protocol"
test_content_contains "WAI-Guide.md has context hygiene rules" "./.WAI/WAI-Guide.md" "Context Hygiene Rules"
test_content_contains "WAI-Guide.md has Compact command" "./.WAI/WAI-Guide.md" "Command: 'Compact'"
